# King9211#!/user/bin/python2
#coding=utf-8
#The Credit For This Code Goes To The Real Trick Aamir 
...
##### LOGO #####
logo = """
\033[1;97m_______                     _____         
\033[1;97m___    |______ ________ ___ ___(_)________
\033[1;92m __  /| |_  __ `/__  __ `__ \__  / __  ___/ 
\033[1;92m _  ___ |/ /_/ / _  / / / / /_  /  _  /    
 \033[1;97m/_/  |_|\__,_/  /_/ /_/ /_/ /_/   /_/     
  \033[1;97m                                      

       \033[1;97m: ___     ___    ___    __  |__ \   / _ \  |__ \  /_ | 
  \033[1;97m ) | | | | |    ) |  | | 
 \033[1;97m / /  | | | |   / /   | | 
 \033[1;97m/ /_  | |_| |  / /_   | | 
\033[1;97m |____|  \___/  |____|  |_|       
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #AAMIR 
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open    https://www.facebook.com/AamirBalouchOfficial')
    else:
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mYour Account is on Successfully"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By AAMIR" #Aamir:Balouch 
